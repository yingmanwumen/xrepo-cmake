package("myzlib")
    ...
    add_patches("v1.2.10", path.join(os.scriptdir(), "patches", "zlib_macos.patch")) -- https://forums.bannister.org/ubbthreads.php?ubb=showflat&Number=124397
    add_patches("v1.2.11", path.join(os.scriptdir(), "patches", "zlib_macos.patch")) -- https://forums.bannister.org/ubbthreads.php?ubb=showflat&Number=124397
